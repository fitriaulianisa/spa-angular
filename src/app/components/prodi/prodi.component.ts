...
export class ProdiComponent implements OnInit { // Mendeklarasikan class komponen dengan implementasi OnInit untuk inisialisasi.
  ...
  apiProdiUrl = 'https://belajar-express-seven.vercel.app/api/prodi'; // URL API untuk mengambil dan menambahkan data prodi.
  apiFakultasUrl = 'https://belajar-express-seven.vercel.app/api/fakultas'; // URL API untuk mengambil data fakultas.
